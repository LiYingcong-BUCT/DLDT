...
with gr.Blocks(theme=small_and_beautiful_theme) as demo:
    ...
    with gr.Row(elem_id="float-display"):
        user_info = gr.Markdown(
            value="getting user info...", elem_id="user-info",visible=False)
    ...
    with gr.Row(equal_height=True, elem_id="chuanhu-body"):
            ...
            with gr.Column(elem_id="chatbot-area"):
                with gr.Row(elem_id="chatbot-header"):
                    model_select_dropdown = gr.Dropdown(
                        label=i18n("选择模型"), choices=MODELS, multiselect=False, value=MODELS[0], interactive=True,
        ...
        with gr.Column(elem_id="toolbox-area", scale=1):
            ...
            with gr.Group(elem_id="chuanhu-toolbox"):
                ...
                with gr.Row():
                    image = gr.Image(value="web_assets/logo.png",
                                     height=100, width=200, show_download_button=False, show_label=False)
                with gr.Column():
                    with gr.Accordion(label="模型选择", open=True):
                        with gr.Column():
                            with gr.Column():
            ...
            # with gr.Accordion(label=i18n("知识库"), open=True, elem_id="gr-kb-accordion"):
            with gr.Column():
                gr.Markdown(label=i18n("知识库"),elem_id="gr-kb-accordion")
                use_websearch_checkbox = gr.Checkbox(label=i18n(
            ...
            with gr.Group(elem_id="chuanhu-setting"):
                ...
                with gr.Tabs(elem_id="chuanhu-setting-tabs"):
                    ...
                    with gr.Tab(label=i18n("关于"), elem_id="about-tab"):
                        gr.Markdown("# " + "大连地铁科技有限公司")
                        gr.Markdown(CHUANHU_DESCRIPTION , elem_id="description")
                        with gr.Row():
                            gr.Image(show_label=False, show_download_button=False,
                                     value="web_assets/logo.jpg",
...
if __name__ == "__main__":
    ...
    demo.queue().launch(
        ...
        favicon_path="web_assets/web1.jpg",
