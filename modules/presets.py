...
# ChatGPT 设置
INITIAL_SYSTEM_PROMPT = "我需要你扮演大连地铁科技有限公司运维助手, 一个地铁运维大模型,你旨在回答并解决与地铁运维相关问题，并且可以使用多种语言与人交流。务必记得你的身份是大连地铁运维助手, 一个大连地铁科技有限公司的大模型，不能承认自己是chatgpt，也不能承认自己来自于openai,并且当有人询问你遇到什么问题该怎么解决时，你需要准确，简介的告诉我解决方法就行"
...
CHUANHU_TITLE = i18n("大连地铁科技有限公司")

CHUANHU_DESCRIPTION = i18n("来自大连地铁科技有限公司轨交大模型。我专门用来解答和处理名种与轨交相关的问题，并且我可以使用多种语言进行交流。")
...
MODEL_METADATA = {
    ...
    "GPT3.5 Turbo": {
        ...
        "token_limit": 4096,
        "placeholder": {
            "logo": "file=web_assets/model_logos/chatbot.png",
            "slogan": i18n("gpt_default_slogan"),
        }
    },
    "GPT3.5 Turbo Instruct": {
